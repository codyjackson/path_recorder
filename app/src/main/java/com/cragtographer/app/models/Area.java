...
import com.cragtographer.app.R;
...
public class Area implements Serializable{
    ...
    public static class NameArrayAdapter extends ArrayAdapter<Area>{
        private Context m_context;

        public NameArrayAdapter(Context context, List<Area> model){
        ...
        public View getView(int position, View convertView, ViewGroup parent){
            ...
            Area modelElement = getItem(position);
